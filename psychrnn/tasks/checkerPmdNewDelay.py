...
class Checkerboard2AFC(Task):
    ...
    def generate_trial_params(self, batch, trial):
        ...
        params["delay"] = (1-np.abs(params["coherence"]))*self.delay_range[1]
    ...
    def trial_function(self, t, params):
        ...
        if t > target_onset + checker_onset + delay:
            ...
            x_t[0] = (params["noise"] ** 2) * np.sqrt(self.dt) * np.random.randn(1)
